...
class TestListProviderTypes:
    ...
    def test_list_provider_types_success(
    ...
    def test_list_provider_types_enterprise_disabled(
...
class TestListProviders:
    ...
    def test_list_providers_non_admin_forbidden(
...
class TestGetProvider:
    ...
    def test_get_provider_non_admin_forbidden(
        self, client, user_auth_headers: Dict
    ) -> None:
...
class TestCreateProvider:
    ...
    def test_create_provider_missing_required_field(
        self, client, auth_headers: Dict
    ) -> None:
    ...
    def test_create_provider_missing_api_key_for_required_type(
        self, client, auth_headers: Dict
    ) -> None:
    ...
    def test_create_provider_ollama_no_key_required(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_create_provider_non_admin_forbidden(
        self, client, user_auth_headers: Dict
    ) -> None:
...
class TestUpdateProvider:
    ...
    def test_update_provider_name_conflict(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestSyncProvider:
    ...
    def test_sync_provider_success(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_sync_provider_sync_disabled(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetProviderModels:
    ...
    def test_get_provider_models_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Missing provider returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
