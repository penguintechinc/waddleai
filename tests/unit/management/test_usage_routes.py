...
class TestGetUsageSummary:
    ...
    def test_summary_admin_gets_all_usage(
        ...
        daily_usage = make_mock_token_usage(
            user_id=1, org_id=1, cost_usd=0.10, usage_date=today
        )
        ...
        assert data['summary']['daily']['date'] == today.isoformat()
    ...
    def test_summary_accumulates_multiple_records(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetUsageByModel:
    ...
    def test_by_model_groups_usage(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Usage grouped by model_used field."""
        gpt4_usage = make_mock_usage_log(
            model='gpt-4o', waddleai_tokens=1000, cost_usd=0.10
        )
        gpt35_usage = make_mock_usage_log(
            model='gpt-3.5-turbo', waddleai_tokens=500, cost_usd=0.01
        )

        app_mock_db.return_value.select.return_value = make_select_result(
            [gpt4_usage, gpt35_usage]
        )
    ...
    def test_by_model_resource_manager_filter(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_by_model_empty_result(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetUsageByProvider:
    ...
    def test_by_provider_groups_usage(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Usage grouped by provider_type field."""
        openai_usage = make_mock_usage_log(
            provider='openai', waddleai_tokens=2000, cost_usd=0.20,
            tokens_input=1000, tokens_output=1000
        )
        anthropic_usage = make_mock_usage_log(
            provider='anthropic', waddleai_tokens=800, cost_usd=0.08,
            tokens_input=400, tokens_output=400
        )
    ...
    def test_by_provider_custom_days(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_provider_empty_result(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetUsageByUser:
    ...
    def test_by_user_admin_sees_all(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_user_resource_manager_filters_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_by_user_regular_user_forbidden(
    ...
    def test_by_user_accumulates_per_user(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_user_unknown_user_handled(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetUsageByKey:
    ...
    def test_by_key_groups_by_virtual_key_id(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_key_admin_sees_all(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_key_resource_manager_filters_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_by_key_no_key_id_skipped(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_by_key_unknown_key_handled(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetCostAnalytics:
    ...
    def test_cost_analytics_daily_breakdown(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_cost_analytics_admin_all_usage(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_cost_analytics_user_filter(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
    ...
    def test_cost_analytics_calculates_projections(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_cost_analytics_empty_result(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestExportUsage:
    ...
    def test_export_json_includes_fields(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """JSON export includes all required fields."""
        usage = make_mock_token_usage(
            user_id=1, org_id=1, key_id=1, waddleai_tokens=1000,
            tokens_input=500, tokens_output=500, request_count=5,
            cost_usd=0.10, usage_date=date(2025, 1, 1)
        )
        app_mock_db.return_value.select.return_value = make_select_result([usage])
    ...
    def test_export_csv_includes_headers(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_export_csv_empty_returns_empty(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_export_default_format_json(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_export_admin_all_usage(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_export_resource_manager_filter(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
