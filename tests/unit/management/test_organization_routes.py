...
class TestListOrganizations:
    ...
    def test_list_orgs_regular_user(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
...
class TestGetOrganization:
    ...
    def test_get_org_non_admin_own_org(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
    ...
    def test_get_org_non_admin_other_org(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
...
class TestCreateOrganization:
    ...
    def test_create_org_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_create_org_duplicate_name(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_create_org_non_admin_forbidden(self, client, user_auth_headers: Dict) -> None:
...
class TestUpdateOrganization:
    ...
    def test_update_org_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_update_org_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_update_org_name_conflict(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
...
class TestDeleteOrganization:
    ...
    def test_delete_org_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_delete_default_org(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_delete_org_has_users(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_delete_org_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing org returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
    ...
    def test_delete_org_non_admin_forbidden(self, client, user_auth_headers: Dict) -> None:
...
class TestGetOrganizationUsage:
    ...
    def test_get_org_usage_admin(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_get_org_usage_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing org returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
