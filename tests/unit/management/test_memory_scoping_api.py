"""Tests for /api/v1/memory-config + /api/v1/memory/<id>/{promote,correct,dispute} (§9.4/§9.7)."""
...
class TestMemoryConfigDefaults:
    """(a) POST/GET /api/v1/memory-config seeds/returns §9.4 defaults (0.7 cutoff, top-3)."""
