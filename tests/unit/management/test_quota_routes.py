...
class TestListQuotas:
    ...
    def test_list_quotas_admin_all_entities(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        ...
        resp = client.get("/api/v1/quotas", headers=auth_headers)
    ...
    def test_list_quotas_resource_manager_org_scoped(
        ...
        resp = client.get("/api/v1/quotas", headers=rm_auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
        assert data["total"] == 3

    def test_list_quotas_empty(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_list_quotas_no_auth(self, client) -> None:
        """Missing auth returns 401."""
        resp = client.get("/api/v1/quotas")
        assert resp.status_code == 401

    def test_list_quotas_invalid_role(self, client, user_auth_headers: Dict) -> None:
        """Regular user (non-admin, non-resource_manager) returns 403."""
        resp = client.get("/api/v1/quotas", headers=user_auth_headers)
...
class TestSetUserQuota:
    ...
    def test_set_user_quota_admin_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_user_quota_resource_manager_own_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_set_user_quota_resource_manager_other_org_forbidden(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_set_user_quota_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_user_quota_no_body(self, client, auth_headers: Dict) -> None:
    ...
    def test_set_user_quota_daily_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_user_quota_monthly_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
...
class TestSetOrganizationQuota:
    ...
    def test_set_org_quota_admin_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_org_quota_resource_manager_forbidden(self, client, rm_auth_headers: Dict) -> None:
    ...
    def test_set_org_quota_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_org_quota_no_body(self, client, auth_headers: Dict) -> None:
        """Missing request body returns 400."""
        resp = client.put(
            "/api/v1/quotas/org/1",
            headers=auth_headers,
    ...
    def test_set_org_quota_daily_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Can update only daily quota."""
        org = make_mock_org()
        app_mock_db.return_value.select.return_value.first.return_value = org
    ...
    def test_set_org_quota_monthly_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Can update only monthly quota."""
        org = make_mock_org()
        app_mock_db.return_value.select.return_value.first.return_value = org
...
class TestSetKeyQuota:
    ...
    def test_set_key_quota_admin_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_key_quota_resource_manager_own_key(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_resource_manager_other_org_forbidden(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_regular_user_own_key(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
    ...
    def test_set_key_quota_regular_user_other_key_forbidden(
    ...
    def test_set_key_quota_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_key_quota_no_body(self, client, auth_headers: Dict) -> None:
        """Missing request body returns 400."""
        resp = client.put(
            "/api/v1/quotas/key/1",
            headers=auth_headers,
    ...
    def test_set_key_quota_budget_daily_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_key_quota_budget_monthly_only(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_set_key_quota_tpm_rpm_limits(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
...
class TestGetQuotaStatus:
    ...
    def test_get_key_quota_status_admin(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/10?type=key", headers=auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_get_key_quota_status_regular_user_own_key(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/10?type=key", headers=user_auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
        assert data["id"] == 10

    def test_get_key_quota_status_regular_user_other_key_forbidden(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        """Regular user cannot get status for another user's key."""
        key = make_mock_key(key_id=10, user_id=3)
        app_mock_db.return_value.select.side_effect = [make_select_result([key])]

        resp = client.get("/api/v1/quotas/status/10?type=key", headers=user_auth_headers)
        assert resp.status_code == 403

    def test_get_key_quota_status_resource_manager_own_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/10?type=key", headers=rm_auth_headers)
        assert resp.status_code == 200

    def test_get_key_quota_status_resource_manager_other_org_forbidden(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_get_key_quota_status_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Non-existent key returns 404."""
        app_mock_db.return_value.select.side_effect = [make_select_result([])]

        resp = client.get("/api/v1/quotas/status/999?type=key", headers=auth_headers)
        assert resp.status_code == 404

    def test_get_key_quota_status_includes_rate_limits(
    ...
    def test_get_user_quota_status_admin(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/5?type=user", headers=auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
    ...
    def test_get_user_quota_status_regular_user_self(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/2?type=user", headers=user_auth_headers)
        assert resp.status_code == 200

    def test_get_user_quota_status_regular_user_other_forbidden(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        """Regular user cannot get status for another user."""
        user = make_mock_user(user_id=5)
        app_mock_db.return_value.select.side_effect = [make_select_result([user])]

        resp = client.get("/api/v1/quotas/status/5?type=user", headers=user_auth_headers)
        assert resp.status_code == 403

    def test_get_user_quota_status_resource_manager_own_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/5?type=user", headers=rm_auth_headers)
        assert resp.status_code == 200

    def test_get_user_quota_status_resource_manager_other_org_forbidden(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
    ...
    def test_get_user_quota_status_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Non-existent user returns 404."""
        app_mock_db.return_value.select.side_effect = [make_select_result([])]

        resp = client.get("/api/v1/quotas/status/999?type=user", headers=auth_headers)
        assert resp.status_code == 404

    def test_get_user_quota_status_includes_usage(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_get_org_quota_status_admin(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/2?type=org", headers=auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
        assert data["type"] == "organization"
        assert data["id"] == 2

    def test_get_org_quota_status_regular_user_own_org(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/1?type=org", headers=user_auth_headers)
        assert resp.status_code == 200

    def test_get_org_quota_status_regular_user_other_org_forbidden(
        self, client, app_mock_db: MagicMock, user_auth_headers: Dict
    ) -> None:
        """Regular user cannot get status for another org."""
        org = make_mock_org(org_id=2)
        app_mock_db.return_value.select.side_effect = [make_select_result([org])]

        resp = client.get("/api/v1/quotas/status/2?type=org", headers=user_auth_headers)
        assert resp.status_code == 403

    def test_get_org_quota_status_resource_manager_own_org(
        self, client, app_mock_db: MagicMock, rm_auth_headers: Dict
    ) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/1?type=org", headers=rm_auth_headers)
        assert resp.status_code == 200

    def test_get_org_quota_status_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Non-existent org returns 404."""
        app_mock_db.return_value.select.side_effect = [make_select_result([])]

        resp = client.get("/api/v1/quotas/status/999?type=org", headers=auth_headers)
        assert resp.status_code == 404

    # --- Invalid Type and No Auth Tests ---

    def test_get_quota_status_invalid_type(self, client, auth_headers: Dict) -> None:
        """Invalid entity type returns 400."""
        resp = client.get("/api/v1/quotas/status/1?type=invalid", headers=auth_headers)
        assert resp.status_code == 400
        data = resp.get_json()
        assert "error" in data

    def test_get_quota_status_default_type_key(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        ...
        resp = client.get("/api/v1/quotas/status/10", headers=auth_headers)
        assert resp.status_code == 200
        data = resp.get_json()
        assert data["type"] == "key"

    def test_get_quota_status_no_auth(self, client) -> None:
        """Missing auth returns 401."""
        resp = client.get("/api/v1/quotas/status/1?type=key")
        assert resp.status_code == 401
