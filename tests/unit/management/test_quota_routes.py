...
class TestListQuotas:
    ...
    def test_list_quotas_admin_all_entities(
    ...
    def test_list_quotas_invalid_role(
...
class TestSetUserQuota:
    ...
    def test_set_user_quota_admin_success(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_user_quota_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_user_quota_daily_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_user_quota_monthly_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestSetOrganizationQuota:
    ...
    def test_set_org_quota_admin_success(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_org_quota_resource_manager_forbidden(
    ...
    def test_set_org_quota_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_org_quota_daily_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Can update only daily quota."""
        org = make_mock_org()
    ...
    def test_set_org_quota_monthly_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Can update only monthly quota."""
        org = make_mock_org()
...
class TestSetKeyQuota:
    ...
    def test_set_key_quota_admin_success(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_regular_user_own_key(
    ...
    def test_set_key_quota_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_budget_daily_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_budget_monthly_only(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_set_key_quota_tpm_rpm_limits(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
...
class TestGetQuotaStatus:
    ...
    def test_get_key_quota_status_admin(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_get_key_quota_status_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Non-existent key returns 404."""
    ...
    def test_get_user_quota_status_admin(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_get_user_quota_status_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Non-existent user returns 404."""
        app_mock_db.return_value.select.side_effect = [make_select_result([])]
    ...
    def test_get_user_quota_status_includes_usage(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_get_org_quota_status_admin(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
    ...
    def test_get_org_quota_status_not_found(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
        """Non-existent org returns 404."""
        app_mock_db.return_value.select.side_effect = [make_select_result([])]
    ...
    def test_get_quota_status_invalid_type(
    ...
    def test_get_quota_status_default_type_key(
        self, client, app_mock_db: MagicMock, auth_headers: Dict
    ) -> None:
