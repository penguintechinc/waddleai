...
class TestListKeys:
    ...
    def test_list_keys_resource_manager(self, client, app_mock_db: MagicMock, rm_auth_headers: Dict) -> None:
    ...
    def test_list_keys_regular_user(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
...
class TestGetKey:
    ...
    def test_get_key_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_get_key_user_own_key(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
    ...
    def test_get_key_user_other_key(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
    ...
    def test_get_key_rm_other_org(self, client, app_mock_db: MagicMock, rm_auth_headers: Dict) -> None:
...
class TestCreateKey:
    ...
    def test_create_key_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_create_key_no_expires(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_create_key_for_other_user_non_admin_forbidden(self, client, user_auth_headers: Dict) -> None:
...
class TestUpdateKey:
    ...
    def test_update_key_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_update_key_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_update_key_user_access_denied(self, client, app_mock_db: MagicMock, user_auth_headers: Dict) -> None:
...
class TestDeleteKey:
    ...
    def test_delete_key_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_delete_key_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing key returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
...
class TestRotateKey:
    ...
    def test_rotate_key_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_rotate_key_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing key returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
...
class TestSyncKey:
    ...
    def test_sync_key_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_sync_key_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing key returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
    ...
    def test_sync_key_non_admin_forbidden(self, client, user_auth_headers: Dict) -> None:
...
class TestGetKeyUsage:
    ...
    def test_get_key_usage_success(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
    ...
    def test_get_key_usage_not_found(self, client, app_mock_db: MagicMock, auth_headers: Dict) -> None:
        """Missing key returns 404."""
        app_mock_db.return_value.select.return_value.first.return_value = None
