...
down_revision: str | None = "004_drop_provider_api_key"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


def upgrade() -> None:
    """Create content_filter_rules, content_filter_audit_log, and content_filter_config tables."""
    ...
    op.create_table(
        ...
        sa.Column(
            "target", sa.String(10), nullable=False, server_default="both"
        ),  # 'input', 'output', 'both'
        sa.Column("pattern", sa.Text, nullable=False),
        sa.Column(
            "action", sa.String(10), nullable=False, server_default="log"
        ),  # 'block', 'redact', 'log'
    ...
    op.create_table(
        ...
        sa.Column(
            "action_taken", sa.String(10), nullable=False
        ...
        sa.Column(
            "auditor_decision", sa.String(10), nullable=True
        ),  # 'block', 'allow', NULL if not invoked
...
def downgrade() -> None:
    """Drop the content_filter_rules, content_filter_audit_log, and content_filter_config tables."""
    # Drop indexes
