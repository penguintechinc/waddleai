...
SUPPORTED_PROVIDERS = {
    ...
    'anthropic': {
        ...
        'models': ['claude-3-5-sonnet-latest', 'claude-3-opus-20240229', 'claude-3-sonnet-20240229', 'claude-3-haiku-20240307'],
        'requires_api_key': True,
    ...
    'bedrock': {
        'name': 'AWS Bedrock',
        'models': ['anthropic.claude-3-sonnet-20240229-v1:0', 'anthropic.claude-3-haiku-20240307-v1:0', 'amazon.titan-text-express-v1', 'meta.llama3-70b-instruct-v1:0'],
        'requires_api_key': True,
...
def sync_provider(provider_id):
    ...
    return jsonify({
        'provider_id': provider_id,
        'sync_status': 'synced',
        'message': 'Provider synced to AILB successfully'
    })
